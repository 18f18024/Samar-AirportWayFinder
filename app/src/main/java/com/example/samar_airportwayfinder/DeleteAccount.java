...
public class DeleteAccount extends AppCompatActivity {
    private TextView u_gender, u_fname, u_phone, u_add, u_age;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        u_gender = (TextView) findViewById(R.id.u_lname);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                u_gender.setText("Gender: "+userProfile.getLastName());
                u_fname.setText("UserName: " +userProfile.getFirstName()+ " "+userProfile.getLastName());
                u_phone.setText("Phone no.: "+userProfile.getUserPhone());
                u_add.setText("Address: "+userProfile.getUserAddress());
                u_age.setText("Age: "+userProfile.getUserAge());
            }

            @Override
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(DeleteAccount.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(DeleteAccount.this, HomePage.class));
        finish();
